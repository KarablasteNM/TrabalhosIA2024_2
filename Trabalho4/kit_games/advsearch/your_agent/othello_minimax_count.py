...
def evaluate_count(state, player:str) -> float:
    ...
    """
    black_pieces = state.board.num_pieces("B")
    white_pieces = state.board.num_pieces("W")
    piece_difference = black_pieces - white_pieces
    return piece_difference if player == "B" else -piece_difference
